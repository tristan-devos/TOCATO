...
select submit_provider_application('Plomberie Carla', array['plumber'], '1234567890', '1111-1111-11',
  ...
  :'carla' || '/photo.jpg');
\echo '--- Sans photo, ou photo dans le dossier de Bob (doivent échouer : invalid_photo_path)'
select submit_provider_application('Plomberie Carla', array['plumber'], '1234567890', '1111-1111-11',
  95, 'Bio', :'carla' || '/id.jpg', :'carla' || '/ass.jpg', null);
select submit_provider_application('Plomberie Carla', array['plumber'], '1234567890', '1111-1111-11',
  95, 'Bio', :'carla' || '/id.jpg', :'carla' || '/ass.jpg', :'bob' || '/photo.jpg');
\echo '--- Carla envoie sa demande (doit réussir), vérif RBQ ok'
select submit_provider_application('Plomberie Carla', array['plumber'], '1234567890', '1111-1111-11',
  95, 'Plombière à Rosemont', :'carla' || '/id.jpg', :'carla' || '/ass.jpg',
  :'carla' || '/photo.jpg') is not null as envoyee;
...
select submit_provider_application('Déménagements Eve', array['mover'], '7777777777', '999',
  110, '', :'eve' || '/id.jpg', :'eve' || '/ass.jpg',
  :'eve' || '/photo.jpg') is not null as envoyee;
...
select p.name, p.services, p.verified, p.user_id = :'carla' as reliee,
       p.photo_path = :'carla' || '/photo.jpg' as photo_publiee
...
select submit_provider_application('Déménagements Eve', array['mover'], '7777777777', null,
  110, 'Camion 20 pieds', :'eve' || '/id2.jpg', :'eve' || '/ass2.jpg',
  :'eve' || '/photo.jpg') is not null as renvoyee;
