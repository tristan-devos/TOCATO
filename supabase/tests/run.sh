...
FILES="schema rpc transitions providers quotes reviews applications photos admin policies"
...
for f in tests/scenarios.sql tests/scenarios-provider.sql tests/scenarios-applications.sql \
    tests/scenarios-photos.sql; do
  echo "--- $f"
